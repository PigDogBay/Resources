...
sed -e "s/TEXT1/Look Up Word/g; s/TEXT2/Definitions Online/g; s/FILENAME/ewiki/g;" template55.svg > appStore55/screenshot5.svg
...
sed -e "s/TEXT1/Look Up Word/g; s/TEXT2/Definitions Online/g; s/FILENAME/ewiki/g;" template65.svg > appStore65/screenshot5.svg
...
sed -e "s/TEXT1/Look Up Word/g; s/TEXT2/Definitions Online/g; s/FILENAME/ewiki/g;" template129.svg > appStore129/screenshot5.svg
