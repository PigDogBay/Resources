...
#Create svg files
sed -e "s/TEXT1/Lots of Features/g; s/TEXT2/Easy To Use/g; s/FILENAME/ahome/g;" template55.svg > appStore55/screenshot1.svg
...
sed -e "s/TEXT1/Apply Filters/g; s/TEXT2/Refine Searches/g; s/FILENAME/dfilter/g;" template55.svg > appStore55/screenshot4.svg
sed -e "s/TEXT1/Crossword Solver/g; s/TEXT2/Unkn.wn Lett.rs/g; s/FILENAME/ecrossword/g;" template55.svg > appStore55/screenshot5.svg
sed -e "s/TEXT1/Blank Letters++/g; s/TEXT2/For Tile Games/g; s/FILENAME/fscrabble/g;" template55.svg > appStore55/screenshot6.svg
sed -e "s/TEXT1/Dark Mode/g; s/TEXT2/Supported/g; s/FILENAME/ghelp-dark/g;" template55.svg > appStore55/screenshot7.svg
...
#Create svg files
sed -e "s/TEXT1/Lots of Features/g; s/TEXT2/Easy To Use/g; s/FILENAME/ahome/g;" template65.svg > appStore65/screenshot1.svg
...
sed -e "s/TEXT1/Apply Filters/g; s/TEXT2/Refine Searches/g; s/FILENAME/dfilter/g;" template65.svg > appStore65/screenshot4.svg
sed -e "s/TEXT1/Crossword Solver/g; s/TEXT2/Unkn.wn Lett.rs/g; s/FILENAME/ecrossword/g;" template65.svg > appStore65/screenshot5.svg
sed -e "s/TEXT1/Blank Letters++/g; s/TEXT2/For Tile Games/g; s/FILENAME/fscrabble/g;" template65.svg > appStore65/screenshot6.svg
sed -e "s/TEXT1/Dark Mode/g; s/TEXT2/Supported/g; s/FILENAME/ghelp-dark/g;" template65.svg > appStore65/screenshot7.svg
...
#Create svg files
sed -e "s/TEXT1/Lots of Features/g; s/TEXT2/Easy To Use/g; s/FILENAME/ahome/g;" template129.svg > appStore129/screenshot1.svg
...
sed -e "s/TEXT1/Apply Filters/g; s/TEXT2/Refine Searches/g; s/FILENAME/dfilter/g;" template129.svg > appStore129/screenshot4.svg
sed -e "s/TEXT1/Crossword Solver/g; s/TEXT2/Unkn.wn Lett.rs/g; s/FILENAME/ecrossword/g;" template129.svg > appStore129/screenshot5.svg
sed -e "s/TEXT1/Blank Letters++/g; s/TEXT2/For Tile Games/g; s/FILENAME/fscrabble/g;" template129.svg > appStore129/screenshot6.svg
sed -e "s/TEXT1/Dark Mode/g; s/TEXT2/Supported/g; s/FILENAME/ghelp-dark/g;" template129.svg > appStore129/screenshot7.svg
